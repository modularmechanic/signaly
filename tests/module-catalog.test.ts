...
const EXPECTED = [
  'adsr', 'arp', 'atn', 'chorus', 'clock', 'clockdiv', 'comb', 'comp', 'crush', 'dist', 'drum2',
  'ddelay', 'duo', 'euklid', 'flanger', 'formant', 'func', 'gate', 'kbd', 'ladder', 'lfo', 'mix',
  'monov', 'mult', 'noise', 'noiselab', 'out', 'quad', 'reverb', 'scope', 'sdelay', 'seq', 'snh',
  'svf', 'tape', 'vca', 'vco', 'volt', 'voct', 'wasp', 'mix8',
] as const;
