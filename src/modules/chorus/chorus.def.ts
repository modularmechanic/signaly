...
import { panel } from './chorus.panel';
...
export const def: ModuleDef = {
  ...
  worklet: 'chorus',
  knobs: [
    { id: 'rate', label: 'RATE', min: 0.05, max: 5, def: 0.5, fmt: 'fHz', curve: 'log', cvIn: 'rcv' },
    { id: 'depth', label: 'DEPTH', min: 0, max: 1, def: 0.5, fmt: 'fPc', cvIn: 'dcv' },
