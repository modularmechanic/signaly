...
export const def: ModuleDef = {
  ...
  knobs: [
    ...
    { id: 'fine', label: 'FINE', min: -7, max: 7, def: 0, fmt: 'fSemi' },
    { id: 'pw', label: 'PW', min: 0.05, max: 0.95, def: 0.5, fmt: 'fPc', cvIn: 'pwm' },
    { id: 'fm', label: 'FM AMT', min: 0, max: 1, def: 0, fmt: 'fPc', cvIn: 'fm' },
    { id: 'fmA', label: 'FM', min: -1, max: 1, def: 0, fmt: 'f1', attenuates: 'fm' },
    { id: 'pwmA', label: 'PWM', min: -1, max: 1, def: 0, fmt: 'f1', attenuates: 'pwm' },
  ],
  ins: [
